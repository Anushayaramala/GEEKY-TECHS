	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.php">	<h2 style="color:#2e62c8 !important;font-weight:600;padding-top:8rem;"> HEALTH HUB | Doctor Login</h2></a>
				</div>

				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend style="color:#2e62c8 !important;font-weight:600;">
							...
							<div class="form-group form-actions">
								...
								<button type="submit" style="background-color:#2e62c8 !important;" class="btn-blu btn btn-primary pull-right  btn-lg btn-block" name="submit">
