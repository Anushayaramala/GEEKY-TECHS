				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><v style="color:#2e62c8 !important;">Doctor</v>  | Edit Doctor Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor</span>
...
<p><b style="color:#2e62c8 !important;">Profile Reg. Date: </b><?php echo htmlentities($data['creationDate']);?></p>
